...
const CreateCategory = () => {
    ...
    return (
        <form className="space-y-6 pb-20" id="createCategoryForm" onSubmit={handleSubmit(onCreateCategory)}>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button type="submit" form="createCategoryForm" className="px-6 py-2.5 rounded-xl text-sm font-bold text-white bg-brandOrange shadow-[0_8px_16px_rgba(249,115,22,0.2)] hover:bg-orange-600 transition">Lưu danh mục</button>
                </div>
            </div>
                    ...
                    <div className="bg-white rounded-[24px] p-8 shadow-soft border border-gray-50 space-y-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    rows="4"
                                    className="w-full px-5 py-3.5 rounded-xl border border-gray-100 bg-secondary/30 focus:bg-white focus:outline-none focus:ring-2 focus:ring-brandOrange/20 focus:border-brandOrange transition text-sm font-medium resize-none"
                                    placeholder="Giới thiệu sơ lược về danh mục..."
